...
var http = require('http')
  ...
  , mimetypes = require('request_mimetypes')
  , oauth = require('request_oauth')
  , uuid = require('request_uuid')
  , ForeverAgent = require('request_forever')
  , Cookie = require('request_vendor_cookie_index')
  , CookieJar = require('request_vendor_cookie_jar')
  , cookieJar = new CookieJar
  , tunnel = require('request_tunnel')
  ;
