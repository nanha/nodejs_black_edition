...
#define Unwrap(target, handle) \
	...
	public:
		...
		static void Init(Handle<Object> target) {
			...
			//target->Set(sym_yield, yield); // nanhapark
			global->Set(sym_yield, yield);
			...
			// Global Fiber
			//target->Set(String::NewSymbol("Fiber"), fn, ReadOnly); // nanhapark
			global->Set(String::NewSymbol("Fiber"), fn, ReadOnly);
...
NODE_MODULE(node_fibers, Fiber::Init)
